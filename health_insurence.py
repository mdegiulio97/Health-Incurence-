# -*- coding: utf-8 -*-
"""Health_insurence.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Asp7LgTXcRYmS5_camYy_oGtORWEBKfD
...
# rimozione outliers
# scelta soglia per rimuovere gli outliers delle variabili numeriche
...
# Convertire le variabili categoriche in variabili dummy (one-hot encoding)
data_numerica = pd.get_dummies(data, drop_first=True)
